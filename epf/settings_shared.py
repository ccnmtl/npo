# Django settings for epf project.
import os.path
...
DATABASE_NAME = 'epf' # Or path to database file if using sqlite3.
...
EMAIL_SUBJECT_PREFIX = "[epf] "
EMAIL_HOST = 'localhost'
SERVER_EMAIL = "epf@ccnmtl.columbia.edu"
